...
const naverClientId = 'PuA93DAvyIPhpV9EaLlP';
export default {
  name: 'naverLogin',
  data() {
    return {
      // 로그인 버튼 이미지
      repo: { name: 'loginBtn', src: require('../../assets/naver/naver_login_green.png') },
    ...
    if (naverLogin.accessToken !== null) {
      naverLogin.getLoginStatus(function(status) {
        if (status) {
          ...
          axios
            .post(`http://i3d202.p.ssafy.io:8000/api/users/naverLogin`, {
